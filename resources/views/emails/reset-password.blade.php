...
<head>
    <meta charset="utf-8">
    <title>Reset Kata Sandi DuaCerita</title>
    <style>
...
<body>
    <div class="card">
        ...
        <p>Kami menerima permintaan untuk menyetel ulang kata sandi akun DuaCerita Anda. Silakan gunakan kode OTP di bawah ini untuk melanjutkan:</p>
        ...
        <p>Jika Anda tidak meminta pengaturan ulang kata sandi ini, silakan abaikan email ini dan pastikan akun Anda tetap aman.</p>
        <div class="footer">
            &copy; 2026 DuaCerita Wedding. All rights reserved.
        </div>
    </div>
</body>
</html>
